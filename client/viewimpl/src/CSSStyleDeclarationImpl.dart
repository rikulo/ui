...
class CSSStyleDeclarationImpl implements CSSStyleDeclaration {
	...
	String getPropertyValue(String propertyName) {
		_check(propertyName);
		return _pcss !== null ? _unwrap(_pcss.getPropertyValue(CSS.$(propertyName))): "";
	}
	...
	CSSValue getPropertyCSSValue(String propertyName)
		=> _pcss !== null ? _pcss.getPropertyCSSValue(CSS.$(propertyName)): null;
	String getPropertyPriority(String propertyName)
		=> _pcss !== null ? _pcss.getPropertyPriority(CSS.$(propertyName)): "";
	String getPropertyShorthand(String propertyName)
		=> _css.getPropertyShorthand(CSS.$(propertyName)); 
			//Not sure what to return by default

	bool isPropertyImplicit(String propertyName)
		=> _css.isPropertyImplicit(CSS.$(propertyName)); //Not sure what to return by default
