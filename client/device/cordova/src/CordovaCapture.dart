...
class CordovaCapture implements Capture {
  ...
  void captureAudio(CaptureSuccessCallback onSuccess, CaptureErrorCallback onError, [CaptureAudioOptions options]) {
    jsutil.jsCall(_CAPTURE_AUDIO, [_wrapCaptureSuccess(onSuccess), _wrapCaptureError(onError), jsutil.toJSMap(_audioOptionsToMap(options))]);
  }
  void captureImage(CaptureSuccessCallback onSuccess, CaptureErrorCallback onError, [CaptureImageOptions options]) {
    jsutil.jsCall(_CAPTURE_IMAGE, [_wrapCaptureSuccess(onSuccess), _wrapCaptureError(onError), jsutil.toJSMap(_imageOptionsToMap(options))]);
  }
  void captureVideo(CaptureSuccessCallback onSuccess, CaptureErrorCallback onError, [CaptureVideoOptions options]) {
    jsutil.jsCall(_CAPTURE_VIDEO, [_wrapCaptureSuccess(onSuccess), _wrapCaptureError(onError), jsutil.toJSMap(_videoOptionsToMap(options))]);
  }
